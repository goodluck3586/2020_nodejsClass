...
app.use(logger('dev'));
app.use(express.static('public'));  // 정적 파일 처리 미들웨어

// req.query 값 확인
// app.get('/', (req, res) => console.log(req.query))

// get 요청 처리(num1 ~ num2까지의 합계)
app.get('/', function(req, res){    // localhost:3000/?num1=1&num2=100
    if(req.query.num1 && req.query.num2){
        ...
        //res.writeHead(302, {"Location": '/sumRequest.html'})
...
app.use(express.urlencoded({ extended: false }));  // body에 담긴 데이터 파싱 미들웨어

app.post('/', function(req, res){
    console.log('req.body: ', req.body)  // {num1: '1', num2: '100'}
